...
/* Mutable struct containing relevant context and state regarding (de)compression with respect to
 * file I/O */
...
Task<int> FIO_compressMultipleFilenames(FIO_ctx_t *const fCtx, FIO_prefs_t *const prefs,
                                        ...
                                        const char *outMirroredDirName, const char *outDirName,
...
Task<int> FIO_decompressMultipleFilenames(FIO_ctx_t *const fCtx, FIO_prefs_t *const prefs,
                                          ...
                                          const char *outMirroredDirName, const char *outDirName,
                                          const char *outFileName, const char *dictFileName);
