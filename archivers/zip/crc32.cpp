// crc32.c — the CRC-32 of a data stream, Mark Adler, 1995.
//
// Upstream's static little-endian table, one of the four it carries; the
// dynamic table, the assembler and the word-at-a-time variants are gone.
// Nothing here is a coroutine: it touches no stream.
...
// Run a set of bytes through the crc shift register. A NULL buf initialises
// the register instead. Returns the current crc either way.
