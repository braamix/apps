...
char *modename[] = {           /* name of modes                */
                     "WRAP", "CMODE", "SPELL", "EXACT", "VIEW", "OVER", "MAGIC", "ASAVE", "UTF-8"
};
...
int quitting                = FALSE;         /* the editor is leaving */
int quit_status             = 0;             /* and this is its status */
...
char *directive_names[] = { "if",   "else",  "endif",    "goto",  "return",
