 ...
 * Bound to "C-W".
 */
Task<int> cmd_kill_region(int f, int n)
{
    int s;
    ...
    co_return delete_bytes(region.r_size, TRUE);
}
 ...
 */
Task<int> cmd_copy_region(int f, int n)
{
    struct line *linep;
    int loffs;
    int s;
 ...
 * "C-X C-L".
 */
Task<int> cmd_case_region_lower(int f, int n)
{
    struct line *linep;
    int loffs;
    int c;
 ...
 * "C-X C-L".
 */
Task<int> cmd_case_region_upper(int f, int n)
{
    struct line *linep;
    int loffs;
    int c;
