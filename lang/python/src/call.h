...
// Argument `at` is a class instance whose class writes `name` in Python:
// call it, put the answer in its place, and enter `again` once more. False
// when there is no such method, and nothing is done.
