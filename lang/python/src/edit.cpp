...
// The anchor is wherever the prompt left the cursor -- after ">>> " or after
// what input() was given -- so this asks rather than moves. FRESH would put
// the edit on a row of its own, which is wrong for a prompt already on this
// one.
